...
namespace ConsultaDocumentos.API.Controllers
{
    ...
    public class EmailController : ControllerBase
    {
        ...
        [HttpPost]
        public virtual async Task<IActionResult> Create([FromBody] EmailDTO dto, CancellationToken ct = default)
        {
        ...
        [HttpPut("{id}")]
        public virtual async Task<IActionResult> Update([FromRoute] Guid id, [FromBody] EmailDTO dto, CancellationToken ct = default)
        {
            dto.Id = id;
