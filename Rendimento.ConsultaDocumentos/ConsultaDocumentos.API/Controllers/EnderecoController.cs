...
namespace ConsultaDocumentos.API.Controllers
{
    ...
    public class EnderecoController : ControllerBase
    {
        ...
        [HttpPost]
        public virtual async Task<IActionResult> Create([FromBody] EnderecoDTO dto, CancellationToken ct = default)
        {
        ...
        [HttpPut("{id}")]
        public virtual async Task<IActionResult> Update([FromRoute] Guid id, [FromBody] EnderecoDTO dto, CancellationToken ct = default)
        {
            dto.Id = id;
