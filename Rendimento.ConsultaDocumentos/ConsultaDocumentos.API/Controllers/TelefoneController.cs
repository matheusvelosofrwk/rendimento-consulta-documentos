...
namespace ConsultaDocumentos.API.Controllers
{
    ...
    public class TelefoneController : ControllerBase
    {
        ...
        [HttpPost]
        public virtual async Task<IActionResult> Create([FromBody] TelefoneDTO dto, CancellationToken ct = default)
        {
        ...
        [HttpPut("{id}")]
        public virtual async Task<IActionResult> Update([FromRoute] Guid id, [FromBody] TelefoneDTO dto, CancellationToken ct = default)
        {
            dto.Id = id;
