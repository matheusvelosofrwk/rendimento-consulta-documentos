...
namespace ConsultaDocumentos.API.Controllers
{
    ...
    public class NacionalidadeController : ControllerBase
    {
        ...
        [HttpPost]
        public virtual async Task<IActionResult> Create([FromBody] NacionalidadeDTO dto, CancellationToken ct = default)
        {
        ...
        [HttpPut("{id}")]
        public virtual async Task<IActionResult> Update([FromRoute] Guid id, [FromBody] NacionalidadeDTO dto, CancellationToken ct = default)
        {
            dto.Id = id;
