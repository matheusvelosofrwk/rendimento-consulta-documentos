...
namespace ConsultaDocumentos.Infra.Data.Migrations
{
    ...
    [Migration("20251025031833_AddCertificadoFieldsToAplicacao")]
    partial class AddCertificadoFieldsToAplicacao
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsultaDocumentos.Domain.Entities.Aplicacao", b =>
                {
                    ...
                    b.Property<DateTime?>("CertificadoDataExpiracao")
                    ...
                    b.Property<string>("CertificadoSenhaCriptografada")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("ConsultaDocumentos.Domain.Entities.AplicacaoProvedor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AplicacaoId", "ProvedorId")
                        .IsUnique()
                        .HasDatabaseName("IX_AplicacaoProvedor_Aplicacao_Provedor");

                    b.HasIndex("AplicacaoId", "ProvedorId", "DataConsulta")
                        .HasDatabaseName("IX_AplicacaoProvedor_Billing");

                    b.ToTable("AplicacaoProvedor");
                });
            ...
            modelBuilder.Entity("ConsultaDocumentos.Domain.Entities.LogAuditoria", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("ConsultaSucesso")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("OrigemCache")
                        .HasColumnType("bit");

                    b.Property<string>("ParametrosEntrada")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProvedorPrincipal")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("ProvedoresUtilizados")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("ConsultaSucesso");

                    b.HasIndex("DataHoraConsulta");

                    b.HasIndex("DocumentoNumero");

                    b.HasIndex("AplicacaoId", "DataHoraConsulta");

                    b.ToTable("LogAuditoria");
                });

            modelBuilder.Entity("ConsultaDocumentos.Domain.Entities.LogErro", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ConsultaDocumentos.Domain.Entities.Provedor", b =>
                {
                    ...
                    b.Property<string>("EndCertificado")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<int?>("QtdAcessoMaximo")
                        .HasColumnType("int");

                    b.Property<int?>("QtdAcessoMinimo")
                        .HasColumnType("int");

                    b.Property<int>("QtdDiasValidadeEND")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(30);

                    b.Property<int>("QtdDiasValidadePF")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(30);

                    b.Property<int>("QtdDiasValidadePJ")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(30);

                    b.Property<int?>("QtdMinEmailLog")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsultaDocumentos.Domain.Entities.QuadroSocietario", b =>
                {
                    ...
                    b.Property<string>("CodPaisOrigem")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.Property<string>("NomePaisOrigem")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("ConsultaDocumentos.Domain.Entities.AplicacaoProvedor", b =>
                {
                    b.HasOne("ConsultaDocumentos.Domain.Entities.Aplicacao", "Aplicacao")
                        .WithMany()
                    ...
                    b.HasOne("ConsultaDocumentos.Domain.Entities.Provedor", "Provedor")
                        .WithMany()
            ...
            modelBuilder.Entity("ConsultaDocumentos.Domain.Entities.LogErro", b =>
                {
                    b.HasOne("ConsultaDocumentos.Domain.Entities.Aplicacao", "Sistema")
                        .WithMany()
